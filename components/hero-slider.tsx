      ...
      <div className="relative z-20 h-full flex items-center">
        <div className="container mx-auto px-6">
          <div className="max-w-3xl text-white">
            ...
            <h2 className="text-xl md:text-2xl mb-6">{slides[currentSlide].subtitle}</h2>
            <p className="text-gray-200 mb-8 leading-relaxed max-w-2xl">
              {slides[currentSlide].description}
            </p>
            <Button className="bg-[#FF7A59] hover:bg-[#FF6A49] text-white px-8 py-6 text-lg rounded-md">
