...
export default function SignupPage() {
    ...
    return (
        <div className="flex min-h-screen">
            <div className="mx-auto flex max-w-[800px] flex-1 flex-col p-4 md:p-8">
                <main className="mx-auto w-full max-w-[560px] flex-1">
                    <div className="flex flex-wrap items-center justify-between">
                        <h2 className="mb-6 text-lg font-medium">소셜 간편 가입</h2>

                        <div className="mb-8 flex justify-center gap-4">
                            <button
                                type="button"
                                className="flex h-12 w-12 items-center justify-center rounded-full bg-[#03C75A] text-white"
                                aria-label="네이버 로그인"
                            >
                                N
                            </button>
                            <button
                                type="button"
                                className="flex h-12 w-12 items-center justify-center rounded-full bg-[#FEE500] text-black"
                                aria-label="카카오 로그인"
                            >
                                K
                            </button>
                            ...
                            <button
                                type="button"
                                className="flex h-12 w-12 items-center justify-center rounded-full border border-gray-300 bg-white"
                                aria-label="구글 로그인"
                            >
                                G
                            </button>
                    ...
                    <div className="mb-6 border-b border-orange-500"></div>

                    <p className="mb-6 text-left">회원가입하고 GAIN과 함께하세요.</p>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                <label htmlFor="name" className="mb-1 block text-sm font-normal">
                                    이름
                                </label>
                                <Input
                                    id="name"
                            ...
                            <div>
                                <label htmlFor="userId" className="mb-1 block text-sm font-normal">
                                    아이디
                                </label>
                                <Input
                                    id="userId"
                        ...
                        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                            ...
                            <div>
                                <label htmlFor="passwordConfirm" className="mb-1 block text-sm font-normal">
                                    비밀번호 확인
                                </label>
                                <div className="relative">
                                    <Input
                            ...
                            {passwordError && (
                                <p className="mt-1 text-xs text-red-500 md:col-span-2">{passwordError}</p>
                            )}
                        </div>

                        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                            <div>
                                <label htmlFor="birthdate" className="mb-1 block text-sm font-normal">
                                    생년월일
                                </label>
                                <Input
                                    id="birthdate"
                            ...
                            <div>
                                <label className="mb-1 block text-sm font-normal">성별</label>
                        ...
                        <div>
                            ...
                            <div className="flex gap-2">
                                <select
                                    className="w-[100px] flex-shrink-0 rounded-md border border-gray-300 bg-white px-2 py-2 text-sm"
                                ...
                                <Button
                                    type="button"
                                    className="bg-[#FF7A59] px-4 whitespace-nowrap text-white hover:bg-[#FF6A49]"
                        ...
                        <div>
                            <label htmlFor="verificationCode" className="mb-1 block text-sm font-normal">
                                인증번호
                            </label>
                            <div className="flex gap-2">
                                <Input
                                ...
                                <Button
                                    type="button"
                                    className="bg-[#FF7A59] px-8 text-white hover:bg-[#FF6A49]"
                                    onClick={() => {
                                        // 여기에 인증번호 확인 로직 추가
                        ...
                        <div className="space-y-3">
                            <div className="flex items-center justify-between gap-8">
                                <label htmlFor="all" className="text-sm font-medium">
                                    필수동의 항목 및 개인정보 수집 및 이용 동의(선택), 광고성 정보 수신(선택)에 모두
                                    동의합니다.
                                </label>
                                <Checkbox
                                    id="all"
                            ...
                            <div className="flex items-center justify-between gap-2">
                                ...
                                <Checkbox
                                    ...
                                    onCheckedChange={(checked) =>
                                        handleCheckboxChange('emailMarketing', checked as boolean)
                                    }
                                />
                            </div>
                            ...
                            <div className="flex items-center justify-between gap-2">
                                ...
                                <Checkbox
                                    ...
                                    onCheckedChange={(checked) =>
                                        handleCheckboxChange('smsMarketing', checked as boolean)
                                    }
                                />
                            </div>
                        </div>
                        ...
                        <Button
                            type="submit"
                            className="h-12 w-full rounded-full bg-[#FF7A59] text-white hover:bg-[#FF6A49]"
                        >
                            가입하기
                        </Button>
                    </form>
