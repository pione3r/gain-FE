        ...
        <main className="mx-auto w-full max-w-[560px] flex-1">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              ...
              {passwordError && <p className="mt-1 text-xs text-red-500 md:col-span-2">{passwordError}</p>}
            </div>
            ...
            <Button type="submit" className="h-12 w-full rounded-full bg-[#FF7A59] text-white hover:bg-[#FF6A49]">
              가입하기
            </Button>
          </form>
        </main>
